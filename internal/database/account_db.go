...
func (a *AccountDB) Get(id string) (*entities.Account, error) {
...
func (a *AccountDB) Save(account *entities.Account) error {
...
func (a *AccountDB) UpdateBalance(account *entities.Account) error {
